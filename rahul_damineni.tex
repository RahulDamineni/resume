    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Plot2Data}
          {To communicate graphical data to visually impaired users, training a neural network to generate tabular data from images. Novel network architecture uses RNN \& CNN encoders with slot based decoder. \textcolor{MidnightBlue}{}}
      \resumeItemListEnd
