...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{ML APIs as a service}
          {Developed an async RESTful micro-service (based on publish-subscribe pattern) with worker scaling, fault-tolerance \& A/B testing capabilities. \textcolor{MidnightBlue}{}}
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Achievement}
          {Optimized a supply chain component that would bridge the gap in production goals and save \$15M annually. Packaged the model as a simulator for business stakeholders' adaption.}
        \resumeItem{Plan Rate Forecasting}
          {Predicted throughput of production mills by performing exploratory data analysis (EDA), conceiving hypotheses, engineering features, to train a regressive model that forecasts rate with 7\% MSE.\textcolor{MidnightBlue}{}}
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Plot2Data}
          {To communicate graphical data to visually impaired users, training a neural network to generate tabular data from images. Novel network architecture uses RNN \& CNN encoders with a slot-based decoder. \textcolor{MidnightBlue}{}}
      \resumeItemListEnd
